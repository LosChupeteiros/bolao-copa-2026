...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[var(--bg-mid)]/97 backdrop-blur-xl border-t border-white/6">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? "text-[var(--secondary)]" : "text-white/20 hover:text-white/40"
              )}
            >
              <div className={cn(
                "w-12 h-8 flex items-center justify-center rounded-full transition-all duration-200",
                active ? "bg-[var(--secondary)]/12" : ""
              )}>
